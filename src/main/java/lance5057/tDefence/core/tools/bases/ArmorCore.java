...
public abstract class ArmorCore extends ArmorBase implements IToolStationDisplay {
	...
	public abstract float durabilityMultiplier();
...
//            
//            multimap.put(SharedMonsterAttributes.ARMOR.getName(), new AttributeModifier(ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor modifier", (double)nbt.armorDefence, 0));
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(@Nonnull EntityEquipmentSlot slot,
		...
		if (slot == this.armorType) {
			...
			multimap.put(SharedMonsterAttributes.ARMOR.getName(), new AttributeModifier(
					ARMOR_MODIFIERS[slot.getIndex()], "Armor modifier", (double) nbt.armorDefence, 0));
