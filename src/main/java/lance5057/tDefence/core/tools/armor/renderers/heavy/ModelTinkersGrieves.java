...
public class ModelTinkersGrieves extends ArmorRenderer {
    ...
    public ModelTinkersGrieves(ItemStack stack) {
        ...
        this.BeltBuckle.addBox(-2.0F, 9.0F, -3.5F, 4, 4, 2, -0.4F);
        ...
        this.setRotateAngle(LegPlateR, 0.0F, 0.0F, 0.261F);
        ...
        this.setRotateAngle(LegPlateBackR, 0.261F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LegPlateBackL, 0.261F, 0.0F, 0.0F);
