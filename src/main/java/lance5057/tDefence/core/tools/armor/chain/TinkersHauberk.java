...
import lance5057.tDefence.core.tools.armor.renderers.chain.ModelTinkersHauberk;
...
public class TinkersHauberk extends ArmorCore {
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> subItems) {
		if (this.isInCreativeTab(tab)) {
			addDefaultSubItems(subItems, TinkerMaterials.iron, TinkerMaterials.iron, TinkerMaterials.iron, TDMaterials.brown.mat, TinkerMaterials.iron);
		}
	}
