package lance5057.tDefence.core.tools.armor.renderers.heavy;
...
//        this.bipedLeftLeg.addChild(ShinGuardL);
        ...
        this.BootCapL.addBox(-1.5F, 10.0F, -4.0F, 3, 2, 2, 0.2F);
        ...
        this.BootCapR.addBox(-1.5F, 10.0F, -4.0F, 3, 2, 2, 0.2F);
        this.bipedRightLeg.addChild(BootCapR);

        this.ShinGuardL = new ModelRenderer(this, 64, 48);
        this.ShinGuardL.mirror = true;
        this.ShinGuardL.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.ShinGuardL.addBox(-2.0F, 4.5F, -2.5F, 4, 5, 3, 0.26F);
        this.setRotateAngle(ShinGuardL, 0.057F, 0.0F, 0.0F);
        this.bipedLeftLeg.addChild(ShinGuardL);

        this.ShinGuardR = new ModelRenderer(this, 64, 48);
        this.ShinGuardR.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.ShinGuardR.addBox(-2.0F, 4.5F, -2.5F, 4, 5, 3, 0.26F);
        this.setRotateAngle(ShinGuardR, 0.057F, 0.0F, 0.0F);
        ...
        this.LegBackL.addBox(-2.0F, 4.5F, 0.6F, 4, 6, 2, 0.27F);
        this.setRotateAngle(LegBackL, -0.057F, 0.0F, 0.0F);
        ...
        this.LegBackR.addBox(-2.0F, 4.5F, 0.6F, 4, 6, 2, 0.27F);
        this.setRotateAngle(LegBackR, -0.057F, 0.0F, 0.0F);
        ...
        this.KneeGuardL.addBox(-2.0F, 4.5F, -2.5F, 4, 3, 4, 0.31F);
        ...
        this.KneeGuardR.addBox(-2.0F, 4.5F, -2.5F, 4, 3, 4, 0.31F);
        ...
        this.KneeGuardCapL.addBox(-1.5F, 3.9F, -3.8F, 3, 2, 1, 0.2F);
        this.setRotateAngle(KneeGuardCapL, 0.174F, 0.0F, 0.0F);
        ...
        this.KneeGuardCapR.addBox(-1.5F, 3.9F, -3.8F, 3, 2, 1, 0.2F);
        this.setRotateAngle(KneeGuardCapR, 0.174F, 0.0F, 0.0F);
