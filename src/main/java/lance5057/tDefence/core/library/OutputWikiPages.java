...
import lance5057.tDefence.core.library.materialutilities.MaterialBase;
...
public class OutputWikiPages {
	public static void outputWikiMaterial(MaterialHelper mat) {
		try {
			PrintWriter out = new PrintWriter(
					"C:\\Users\\Tyler\\Documents\\Tinkers-Defence.wiki\\" + mat.mat.getLocalizedName() + ".md");
	...
	public static void outputWikiSidebar(List<MaterialHelper> materials) {
		try {
			PrintWriter out = new PrintWriter("C:\\Users\\Tyler\\Documents\\Tinkers-Defence.wiki\\_Sidebar.md");
			...
			for (MaterialHelper m : materials) {
				out.write("[" + m.mat.getLocalizedName() + "](https://github.com/Lance5057/Tinkers-Defence/wiki/"
