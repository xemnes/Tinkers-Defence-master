...
public class ArmorRefineryGuiButtons extends GuiSideButtons {

  protected final ArmorRefineryGui parent;

  public ArmorRefineryGuiButtons(ArmorRefineryGui parent, Container container, int columns) {
  ...
  public void updatePosition(int parentX, int parentY, int parentSizeX, int parentSizeY) {
    ...
    {
      GuiButtonItem<ArmorBuildGuiInfo> button = new ArmorRefineryGuiButtonRepair(index++, -1, -1);
