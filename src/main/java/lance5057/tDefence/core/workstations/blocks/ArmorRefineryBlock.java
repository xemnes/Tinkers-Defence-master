...
public class ArmorRefineryBlock extends BlockTable implements ITinkerStationBlock {

	public ArmorRefineryBlock() {
		super(Material.IRON);
		this.setUnlocalizedName("armorrefinery");
		this.setRegistryName("armorrefinery");
