...
public class CommonProxy implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		Object obj = TDWorkstations.getServerGuiElement(ID, player, world, x, y, z);
		if (obj == null)
			switch (ID) {
			}
		return obj;
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		Object obj = TDWorkstations.getClientGuiElement(ID, player, world, x, y, z);
		if (obj == null)
			switch (ID) {
			}
		return obj;
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		TinkersDefence.parts.registerItems(event);
		TinkersDefence.tools.registerItems(event);
		TinkersDefence.items.registerItems(event);
	}
...
//	}
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) {
		TinkersDefence.tools.registerBlocks(event);
		TinkersDefence.blocks.registerBlocks(event);
	}
