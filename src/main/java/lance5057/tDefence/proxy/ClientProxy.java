package lance5057.tDefence.proxy;

import javax.annotation.Nonnull;

import lance5057.tDefence.Reference;
import lance5057.tDefence.TDCommands;
...
import lance5057.tDefence.core.library.CustomArmorTextureCreator;
import lance5057.tDefence.core.library.TDClientRegistry;
import lance5057.tDefence.core.library.TDModelLoader;
import lance5057.tDefence.core.library.TDModelRegistar;
...
import lance5057.tDefence.renderers.deserializers.AlphaColorTextureDeserializer;
...
public class ClientProxy extends CommonProxy {
	...
	public void preInit() {
		...
		ClientCommandHandler.instance.registerCommand(new TDCommands());
	...
	public void init() {
		...
		TDBook.INSTANCE.fontRenderer = bookRenderer;
