package lance5057.tDefence.core.addons.bloodmagic;

import WayofTime.bloodmagic.core.RegistrarBloodMagicItems;
import lance5057.tDefence.TinkersDefence;
import lance5057.tDefence.core.addons.bloodmagic.modifiers.ModScabbing;
import lance5057.tDefence.core.addons.bloodmagic.modifiers.ModWill;
...
//			new LegsMaterialStats(600, 3, 2, 20), new FeetMaterialStats(600, 2, 1, 20));
	...
	public void preInit(FMLPreInitializationEvent e) {
		//bloodyBandages = TCItems.registerItem("bloodybandages", TinkersDefence.tab);
...
//		DefenceMaterials.materials.add(this.etherealslate);
		...
		//TinkersDefence.proxy.registerItemRenderer(bloodyBandages, 0, "bloodmagic/bloodybandages");

		TinkersDefence.proxy.registerModifierModel(scabbing);
		TinkersDefence.proxy.registerModifierModel(will);
	}
