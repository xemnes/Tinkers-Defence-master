...
public class ModelTinkersHelm extends ArmorRenderer {
    ...
    public ModelTinkersHelm(EntityEquipmentSlot slotIn) {
        ...
        this.setRotateAngle(MouthGuard, 0.349F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Visor, -0.087F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(MouthGuard_Closed, 0.349F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Visor_Closed, -0.087F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Visor_Open, -0.436F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(MouthGuard_Open, 0.878F, 0.0F, 0.0F);
