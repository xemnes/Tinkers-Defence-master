...
import lance5057.tDefence.core.materials.traits.*;
...
public class TDTraits {
	...
	public void init() {
		...
		TinkerMaterials.lead.addTrait(ArmorTraits.heavy, HelmMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.shielding, HelmMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.heavy, ChestMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.shielding, ChestMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.heavy, LegsMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.shielding, LegsMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.heavy, FeetMaterialStats.TYPE);
		TinkerMaterials.lead.addTrait(ArmorTraits.shielding, FeetMaterialStats.TYPE);
